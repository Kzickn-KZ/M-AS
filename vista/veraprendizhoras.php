...
?>
        ...
        include_once '../../controlador/class.horas.php';
                    ...
                    echo "<br>";
                    echo "<br>";
        $query=Horas::imprimirHoras("WHERE usuario.id_usuario=$_SESSION[id_usuario] and  horas.documento='$_GET[codigoo]'");
        echo '<div class="datagrid" style="width:65%">';
                echo '<table  id="horas" >';
                    echo'<thead>';
    ...
    ?>
        ...
        while($arreglo=mysqli_fetch_array($query)){
            ...
            echo "<td><a href='prueba.php?codigo=$arreglo[0]&codigoborrarr=2'><span class='glyphicon glyphicon-remove-circle'></a></td>";
            echo "<td><a href='prueba.php?codigo=$arreglo[0]&codigohabilitarr=2'><span class='glyphicon glyphicon-ok-circle'></a></td>";
        echo "</tr>";
        }
        echo "</table>";
            ?>
