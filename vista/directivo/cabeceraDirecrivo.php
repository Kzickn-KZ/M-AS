            ...
            <nav class="navbar navbar-default" role="navigation">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.php">M&AS</a>
                    </div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
                                    <li>
                                        <a href="inicio_directivo.php">Inicio
                                        </a>
                                    </li>
                                    <li>
                                        <a href="consultar_aprendiz.php">citar
                                        </a>
                                    </li>
                                    <li>
                                        <a href="Aprendicess.php">Aprendices
                                        </a>
                                    </li>
                                    <li>
                                        <a href="tablacitaciones.php">Tabla Citaciones
                                        </a>
                                    </li>
                                    <li>
                                        <a href="horasadmin.php"> Horas Aprendices
                                        </a>
                                    </li>
                                    <li>
