...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->image('../img/icono.png', 196, 10, 30, 30 );
        $this->Cell(251, 5, 'SERVICIO NACIONAL DE APRENDIZAJE SENA', 0, 100,'R');
        $this->Cell(250, 5, 'MONITORIAS Y APOYO DE SOSTENIMIENTO', 0, 100,'R');
        $this->Ln(5);
        $this->Cell(230, 5, 'REPORTE DE NOVEDADES', 0, 100,'R');
        $this->Ln(20);
    ...
    function Footer()
    {
        ...
        $this->Cell(0,10,'Monitorias y apoyo de sostenimiento SENA','T',0,'C');
    }
    ...
    function datosVertical($datos)
    {
        ...
        foreach($datos as $fila)
        {
            ...
            $this->Cell(40,7,$fila['tipo'],'1',NULL,NULL,NULL,NULL);
            $this->Cell(40,7,$fila['documento'],'1',NULL,NULL,NULL,NULL);
            $this->Cell(40,7,$fila['fecha'],'1',NULL,NULL,NULL,NULL);
            $this->Cell(40,7,$fila['supervisor'],'1',NULL,NULL,NULL,NULL);
