...
echo "<script>location.href='../vista/directivo/inicio_directivo.php'</script>";
}
}
...
echo "<script>location.href='../vista/aprendiz/iniciousu.php'</script>";
...
echo "<script>location.href='../vista/errorusu.php'</script>";
