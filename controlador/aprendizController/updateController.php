<div class="box" id="contenido">
        ...
        <form action="../../controlador/ejecutaupdateuser.php" method="POST">
            ...
            Contraseña
            <input name="contrasena" id="contrasena" type="password" value="<?php echo $regee[contrasena]?>"
                placeholder="Contraseña" required="required" style="width:30%; height:8%" class="form-control">
            Sede
